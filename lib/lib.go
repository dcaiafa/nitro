...
var allExports = []export{
	...
	{P: "file", N: "is_dir", T: exportFunc, F: fileIsDir},
	{P: "file", N: "ls", T: exportFunc, F: fileLs},
	{P: "file", N: "mkdir_all", T: exportFunc, F: fileMkdirAll},
	{P: "file", N: "open", T: exportFunc, F: fileOpen},
	{P: "file", N: "read", T: exportFunc, F: fileRead},
	{P: "file", N: "remove", T: exportFunc, F: fileRemove},
	{P: "file", N: "remove_all", T: exportFunc, F: fileRemoveAll},
	{P: "file", N: "rename", T: exportFunc, F: fileRename},
	{P: "file", N: "seek", T: exportFunc, F: fileSeek},
	{P: "file", N: "stat", T: exportFunc, F: fileStat},
	{P: "file", N: "write_to", T: exportFunc, F: fileWriteTo},
	{P: "filepath", N: "base", T: exportFunc, F: pathBase},
	{P: "filepath", N: "clean", T: exportFunc, F: pathClean},
	{P: "filepath", N: "dir", T: exportFunc, F: pathDir},
	{P: "filepath", N: "ext", T: exportFunc, F: pathExt},
	{P: "filepath", N: "from_slash", T: exportFunc, F: pathFromSlash},
	{P: "filepath", N: "join", T: exportFunc, F: pathJoin},
	{P: "filepath", N: "match", T: exportFunc, F: pathMatch},
	{P: "filepath", N: "to_slash", T: exportFunc, F: pathToSlash},
	...
	{P: "map", N: "clone", T: exportFunc, F: mapClone},
	{P: "map", N: "delete", T: exportFunc, F: mapDelete},
	{P: "map", N: "update", T: exportFunc, F: mapUpdate},
