...
func RegisterAll(c *nitro.Compiler) {
	...
	c.AddNativeFn("path_base", pathBase)
	c.AddNativeFn("path_clean", pathClean)
	c.AddNativeFn("path_dir", pathDir)
	c.AddNativeFn("path_ext", pathExt)
	c.AddNativeFn("path_from_slash", pathFromSlash)
	c.AddNativeFn("path_join", pathJoin)
	c.AddNativeFn("path_match", pathMatch)
	c.AddNativeFn("path_to_slash", pathToSlash)
